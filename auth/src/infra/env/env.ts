...
export const envSchema = z.object({
  ...
  DATABASE_PORT: z.coerce.number().default(5456),
  ...
  MAIL_SECURE: z.string().default('mail'),
  MAIL_PORT: z.coerce.number().default(0),
  MAIL_USER: z.string().default('mail'),
  MAIL_USER_EMAIL: z.string().default('mail'),
  MAIL_PASSWORD: z.string().default('mail'),
