...
} from 'src/domain/auth/application/repositories/user.repository';
import { PrismaService } from '../prisma.service';
import { RedisRepository } from '../../redis/redis.service';
import { User, UserKey } from 'src/domain/auth/entities/user';
import {
  PrismaUserMapper,
  UserWithInclude,
} from '../mappers/prisma-user-mapper';
import { UserCreatedProducer } from 'src/infra/events/kafka/producers/user-created.producer';
...
export class PrismaUserRepository implements UserRepository {
  ...
  async create(user: User) {
    ...
    await this.userCreatedProducer.emit(user);
